...
file must have the same strucutre or else it freaks out. Or more correctly,
...
+ v0.3.0 (2015-12-02)
  + Added ability to expand only branches that have differences in them.

+ v0.2.0 (2015-11-11)

    + Updated build scripts
    + Added display area for total # of differences found.
    + Updated imports
    + Program title now displays version and release date
...
def _setup_logging():
    ...
    Log lines look like so::
        ...
        2015-06-23 17:04:10.409 [DEBUG   ] [gui     ] [_col...dolla]  msg...
        |--------| |----------| |--------| |--------| |----...-----|  |----)
             ^          ^            ^          ^            ^          ^
             |          |            |          |            |          |
        Date +          |            |          |            |          |
